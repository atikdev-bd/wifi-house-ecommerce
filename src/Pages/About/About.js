        ...
        <div>
          <div className="item-center text-center">
            <img
              ...
              alt=""
            />
            <h1 className="text-sm lg:text-xl mt-4  font-bold">Customer Support</h1>
           
          </div>
        </div>
        <div>
          <img
            className="w-20 ml-12 bg-emerald-500  hover:bg-gray-500 p-4 rounded-full"
            src={img2}
            alt=""
          />
          <div className="item-center text-center">
            <h1 className="lg:text-xl mt-4 font-bold">Our Service Discount</h1>
           
          </div>
        </div>
        <div>
          <img
            className="w-20 ml-12 bg-gray-500 hover:bg-emerald-500  p-4 rounded-full"
            src={img3}
            alt=""
          />
          <div className="item-center text-center">
            <h1 className="lg:text-xl mt-4 font-bold">Our Service Review</h1>
